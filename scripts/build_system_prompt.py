...
3. Con la sucursal elegida usa consultar_disponibilidad (desde hoy, ventana \
de 14 días) y presenta primero las FECHAS con cupo (tipo "lista", id \
"fecha_<YYYY-MM-DD>", etiqueta = fecha_legible como "Lun 20 jul").
4. Presenta los HORARIOS del día elegido (tipo "lista", id "slot_<slot_id>", \
etiqueta = hora como "11:00").
