...
- Botones del recordatorio de cita (llegan como [selección interactiva]): \
id=recordatorio_confirmar → agradécele y recuérdale llegar 10 minutos \
antes, sin llamar tools. id=recordatorio_cancelar → busca su cita con \
consultar_mis_citas y cancélala solo tras confirmación con botones. \
id=recordatorio_reagendar → busca su cita con consultar_mis_citas, ofrece \
fechas en la MISMA sucursal (consultar_disponibilidad) y, cuando elija y \
confirme, agenda la nueva y DESPUÉS cancela la anterior: nunca lo dejes \
sin ninguna cita.
